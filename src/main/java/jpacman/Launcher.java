...
/**
 * Creates and launches the JPacMan UI.创建并启动JPacMan UI。
 * 
...
public class Launcher {
    ...
    /**
     * Set the name of the file containing this level's map.设置包含该关卡地图的文件的名称。
     *
     * @param fileName
     *            Map to be used.
     * @return Level corresponding to the given map.对应于给定地图的级别。
     */
